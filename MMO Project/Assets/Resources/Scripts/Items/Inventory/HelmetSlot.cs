...
public class HelmetSlot : InventorySlot {
    ...
    public override void SetHeldItem()
    {
        if (HeldItem != null)
        {
            ...
            PlayerPrefs.SetString("HelmetID" + SlotNumber, ItemIDHeld);
            PlayerPrefs.SetInt("HelmetCount" + SlotNumber, ItemsHeld);
            //Debug.Log("SlotID" + SlotNumber + " ID Saved: " + ItemIDHeld + ", Amount: " + ItemsHeld);
        }
        else
        {
            PlayerPrefs.SetString("HelmetID" + SlotNumber, "None");
            PlayerPrefs.SetInt("HelmetCount" + SlotNumber, 0);
        }
    ...
    {
        ItemIDHeld = PlayerPrefs.GetString("HelmetID" + SlotNumber, "None");
        if (ItemIDHeld == "None")
        {
        ...
        {
            ItemsHeld = PlayerPrefs.GetInt("HelmetCount" +
                "" + SlotNumber, 1);
            ...
            if (HeldItem != null)
            {
                Durability = PlayerPrefs.GetInt("HelmetID_Durability" + SlotNumber, Durability);
                SetDurability(Durability);
    ...
    public override Item SwapItem(Item i = null)
    {
        ...
        if (ATemp != null)
        {
            ...
            if  (aSlot == Armor.ArmorSlot.Helmet)
            {
                HeldItem = i;
                SetHeldItem();
                UpdateItemDisplay();
    ...
    public override void SwapItem(InventorySlot IS)
    {
        if (IS.GetHeldItem() != null)
        {
            ...
            if (Atemp != null)
            {
                if (Atemp.GetSlot() == Armor.ArmorSlot.Helmet)
                {
    ...
    {
        Durability = durable;
        PlayerPrefs.SetInt("HelmetID_Durability" + SlotNumber, Durability);
        if (HeldItem != null)
