...
public class TertiarySlot : InventorySlot
{
    ...
    public override void SetHeldItem()
    {
        if (HeldItem != null)
        {
            ...
            PlayerPrefs.SetString("TertiaryID" + SlotNumber, ItemIDHeld);
            PlayerPrefs.SetInt("TertiaryCount" + SlotNumber, ItemsHeld);
            //Debug.Log("SlotID" + SlotNumber + " ID Saved: " + ItemIDHeld + ", Amount: " + ItemsHeld);
        }
        else
        {
            PlayerPrefs.SetString("TertiaryID" + SlotNumber, "None");
            PlayerPrefs.SetInt("TertiaryCount" + SlotNumber, 0);
        }
    ...
    {
        ItemIDHeld = PlayerPrefs.GetString("TertiaryID" + SlotNumber, "None");
        if (ItemIDHeld == "None")
        {
        ...
        {
            ItemsHeld = PlayerPrefs.GetInt("TertiaryCount" +
                "" + SlotNumber, 1);
            ...
            if (HeldItem != null)
            {
                Durability = PlayerPrefs.GetInt("TertiaryID_Durability" + SlotNumber, Durability);
                SetDurability(Durability);
    ...
    public override Item SwapItem(Item i = null)
    {
        ...
        if (WTemp != null)
        {
            ...
            if (WTemp.GetSlot() == Weapon.WeaponSlot.Tertiary || WTemp.GetSlot() == Weapon.WeaponSlot.All)
            {
                HeldItem = i;
                SetHeldItem();
                UpdateItemDisplay();
    ...
    {
        Durability = durable;
        PlayerPrefs.SetInt("TertiaryID_Durability" + SlotNumber, Durability);
        if (HeldItem != null)
