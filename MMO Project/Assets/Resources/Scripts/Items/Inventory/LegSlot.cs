...
public class LegSlot : InventorySlot
{
    ...
    public override void SetHeldItem()
    {
        if (HeldItem != null)
        {
            ...
            PlayerPrefs.SetString("LegID" + SlotNumber, ItemIDHeld);
            PlayerPrefs.SetInt("LegCount" + SlotNumber, ItemsHeld);
            //Debug.Log("SlotID" + SlotNumber + " ID Saved: " + ItemIDHeld + ", Amount: " + ItemsHeld);
        }
        else
        {
            PlayerPrefs.SetString("LegID" + SlotNumber, "None");
            PlayerPrefs.SetInt("LegCount" + SlotNumber, 0);
        }
    ...
    {
        ItemIDHeld = PlayerPrefs.GetString("LegID" + SlotNumber, "None");
        if (ItemIDHeld == "None")
        {
        ...
        {
            ItemsHeld = PlayerPrefs.GetInt("LegCount" +
                "" + SlotNumber, 1);
            ...
            if (HeldItem != null)
            {
                Durability = PlayerPrefs.GetInt("LegID_Durability" + SlotNumber, Durability);
                SetDurability(Durability);
    ...
    public override Item SwapItem(Item i = null)
    {
        ...
        if (ATemp != null)
        {
            ...
            if (aSlot == Armor.ArmorSlot.Leggings)
            {
                HeldItem = i;
                SetHeldItem();
                UpdateItemDisplay();
    ...
    public override void SwapItem(InventorySlot IS)
    {
        if (IS.GetHeldItem() != null)
        {
            ...
            if (Atemp != null)
            {
                if (Atemp.GetSlot() == Armor.ArmorSlot.Leggings)
                {
    ...
    {
        Durability = durable;
        PlayerPrefs.SetInt("LegID_Durability" + SlotNumber, Durability);
        if (HeldItem != null)
