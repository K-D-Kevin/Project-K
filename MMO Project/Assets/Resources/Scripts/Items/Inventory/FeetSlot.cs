...
public class FeetSlot : InventorySlot
{
    ...
    public override void SetHeldItem()
    {
        if (HeldItem != null)
        {
            ...
            PlayerPrefs.SetString("FeetID" + SlotNumber, ItemIDHeld);
            PlayerPrefs.SetInt("FeetCount" + SlotNumber, ItemsHeld);
            //Debug.Log("SlotID" + SlotNumber + " ID Saved: " + ItemIDHeld + ", Amount: " + ItemsHeld);
        }
        else
        {
            PlayerPrefs.SetString("FeetID" + SlotNumber, "None");
            PlayerPrefs.SetInt("FeetCount" + SlotNumber, 0);
        }
    ...
    {
        ItemIDHeld = PlayerPrefs.GetString("FeetID" + SlotNumber, "None");
        if (ItemIDHeld == "None")
        {
        ...
        {
            ItemsHeld = PlayerPrefs.GetInt("FeetCount" +
                "" + SlotNumber, 1);
            ...
            if (HeldItem != null)
            {
                Durability = PlayerPrefs.GetInt("FeetID_Durability" + SlotNumber, Durability);
                SetDurability(Durability);
    ...
    public override void SwapItem(InventorySlot IS)
    {
        if (IS.GetHeldItem() != null)
        {
            ...
            if (Atemp != null)
            {
                if (Atemp.GetSlot() == Armor.ArmorSlot.Footware)
                {
    ...
    {
        Durability = durable;
        PlayerPrefs.SetInt("FeetID_Durability" + SlotNumber, Durability);
        if (HeldItem != null)
