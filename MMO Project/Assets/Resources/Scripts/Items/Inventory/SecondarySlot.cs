...
public class SecondarySlot : InventorySlot
{
    ...
    public override void SetHeldItem()
    {
        if (HeldItem != null)
        {
            ...
            PlayerPrefs.SetString("SecondaryID" + SlotNumber, ItemIDHeld);
            PlayerPrefs.SetInt("SecondaryCount" + SlotNumber, ItemsHeld);
            //Debug.Log("SlotID" + SlotNumber + " ID Saved: " + ItemIDHeld + ", Amount: " + ItemsHeld);
        }
        else
        {
            PlayerPrefs.SetString("SecondaryID" + SlotNumber, "None");
            PlayerPrefs.SetInt("SecondaryCount" + SlotNumber, 0);
        }
    ...
    {
        ItemIDHeld = PlayerPrefs.GetString("SecondaryID" + SlotNumber, "None");
        if (ItemIDHeld == "None")
        {
        ...
        {
            ItemsHeld = PlayerPrefs.GetInt("SecondaryCount" +
                "" + SlotNumber, 1);
            ...
            if (HeldItem != null)
            {
                Durability = PlayerPrefs.GetInt("SecondaryID_Durability" + SlotNumber, Durability);
                SetDurability(Durability);
    ...
    public override Item SwapItem(Item i = null)
    {
        ...
        if (WTemp != null)
        {
            ...
            if (WTemp.GetSlot() == Weapon.WeaponSlot.PrimarySecondary || WTemp.GetSlot() == Weapon.WeaponSlot.Secondary || WTemp.GetSlot() == Weapon.WeaponSlot.All)
            {
                HeldItem = i;
                SetHeldItem();
                UpdateItemDisplay();
    ...
    {
        Durability = durable;
        PlayerPrefs.SetInt("SecondaryID_Durability" + SlotNumber, Durability);
        if (HeldItem != null)
