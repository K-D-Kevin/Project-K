...
public class ChestPieceSlot : InventorySlot
{
    ...
    public override void SetHeldItem()
    {
        if (HeldItem != null)
        {
            ...
            PlayerPrefs.SetString("ChestID" + SlotNumber, ItemIDHeld);
            PlayerPrefs.SetInt("ChestCount" + SlotNumber, ItemsHeld);
            //Debug.Log("SlotID" + SlotNumber + " ID Saved: " + ItemIDHeld + ", Amount: " + ItemsHeld);
        }
        else
        {
            PlayerPrefs.SetString("ChestID" + SlotNumber, "None");
            PlayerPrefs.SetInt("ChestCount" + SlotNumber, 0);
        }
    ...
    {
        ItemIDHeld = PlayerPrefs.GetString("ChestID" + SlotNumber, "None");
        if (ItemIDHeld == "None")
        {
        ...
        {
            ItemsHeld = PlayerPrefs.GetInt("ChestCount" +
                "" + SlotNumber, 1);
            ...
            if (HeldItem != null)
            {
                Durability = PlayerPrefs.GetInt("ChestID_Durability" + SlotNumber, Durability);
                SetDurability(Durability);
    ...
    public override Item SwapItem(Item i = null)
    {
        ...
        if (ATemp != null)
        {
            ...
            if (aSlot == Armor.ArmorSlot.Chestpiece)
            {
                HeldItem = i;
                SetHeldItem();
                UpdateItemDisplay();
    ...
    public override void SwapItem(InventorySlot IS)
    {
        ...
        {
            Armor Atemp = IS.GetHeldItem().GetComponent<Armor>();
            if (Atemp != null)
            {
                if (Atemp.GetSlot() == Armor.ArmorSlot.Chestpiece)
                {
    ...
    {
        Durability = durable;
        PlayerPrefs.SetInt("ChestID_Durability" + SlotNumber, Durability);
        if (HeldItem != null)
